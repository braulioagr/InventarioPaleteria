...
public class AltaRestock extends javax.swing.JFrame {
    ...
    public String idProducto,cantidad;
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(cantidadsp, javax.swing.GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE)
                        .addGap(14, 14, 14))))
        );
    ...
    private void DataProductoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_DataProductoMouseClicked
        ...
        idProducto = modelo.getValueAt(fila,0).toString();
    ...
    private void aceptarbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarbtnActionPerformed
        if(!"".equals(idProducto))
        {
            ...
            cantidad = cantidadsp.getValue().toString();
            Nexo.ejecutaSQL("insert into empleado.InventarioProducto(idinventario,idproducto,cantidadrecibida) values("+idInventario+","+idProducto+","+cantidad+")", false);
           
            Restock.ActualizagridInventario();
            Restock.ActualizagridInventarioP();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AltaRestock(idInventario).setVisible(true);
            }
        });
    }
